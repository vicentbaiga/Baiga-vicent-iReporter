...
@app.route('/api/v1/red-flags/<int:id>', methods=['PUT'])
def update_location(id):
    ...
    for i in redflag :
        if i.__dict__['id'] == id:
            i.__dict__['location'] = location
            return jsonify({"status":"success", "message": "redflag successfully updated"})
    return jsonify({"message": "reflag not found"})
